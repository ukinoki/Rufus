...
UpSmallButton::StyleBouton UtilsMessageBox::Watch(QWidget *parent, QString Text, QString InfoText)
{
    UtilsMessageBox*msgbox  = new UtilsMessageBox(parent);

    QMovie *m_movie         = new QMovie(":/warning.gif");
    m_movie                 ->setScaledSize(QSize(80,80));
    msgbox->wdg_iconlbl     ->setMovie(m_movie);
    ...
    msgbox                  ->AjouteLayButtons(ButtonOK);
