...
public:
    ...
    static QIcon icEyeBarre() { return foundIC("icEyeBarre", "://eye-color-icon-barre.png", QSize(40,40)); }
    ...
    static QIcon icPasswordMySQL() { return foundIC("icPasswordMySQL", "://passwordmysql.ico"); }
