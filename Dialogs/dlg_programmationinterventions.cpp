...
//    //création de l'entête
    ...
    if (incidents)
    {
        textcorps += "<p align=\"left\"><font color = " COULEUR_TITRES "><span style=\"font-size:10pt;\"><b>" + tr("INCIDENTS PAR INTERVENTION") + "</b></span></font>" ;
        foreach (Intervention* interv, *Datas::I()->interventions->interventions())
        {
            if (interv->incident() != "")
            {
...
void dlg_programmationinterventions::FicheIntervention(Intervention *interv)
{
    ...
    connect(dlg_intervention->OKButton, &QPushButton::clicked, dlg_intervention, [=, this, &dlg_intervention]
    {
