...
private:
    QString TITRUSER            = STR_TITRUSER;
    QString NOMPAT              = STR_NOMPAT;
    QString DATEDOC             = STR_DATEDOC;
    QString DDNPAT              = STR_DDNPAT;
    QString NNIPAT              = STR_NNIPAT;
    QString TITREPAT            = STR_TITREPAT;
    QString AGEPAT              = STR_AGEPAT;
    QString PRENOMPAT           = STR_PRENOMPAT;
    QString SEXEPAT             = STR_SEXEPAT;
    QString MGPAT               = STR_MGPAT;
    QString MGPATTITRE          = STR_MGPATTITRE;
    QString POLITESSEMG         = STR_POLITESSEMG;
    QString PRENOMMG            = STR_PRENOMMG;
    QString NOMMG               = STR_NOMMG;
    QString REFRACT             = STR_REFRACT;
    QString KERATO              = STR_KERATO;
    QString POLITESSECOR        = STR_POLITESSECOR;
    QString CORPAT              = STR_CORPAT;
    QString ADRCORPAT           = STR_ADR_CORPAT;
    QString PRENOMCOR           = STR_PRENOMCOR;
    QString NOMCOR              = STR_NOMCOR;
    QString PRENOMUSER          = STR_PRENOMUSER;
    QString NOMUSER             = STR_NOMUSER;
    QString TELEPHONE           = STR_TELEPHONE;

    QString ANESTHINTERVENTION  = STR_ANESTHINTERVENTION;
    QString PROVENANCE          = STR_PROVENANCE;
    QString TYPESEJOUR          = STR_TYPESEJOUR;
    QString COTEOEIL            = STR_EYE;
    QString COTEBRUT            = STR_SIDE;
    QString YESNO               = STR_YESNO;
    QString SITE                = STR_SITE;
    QString SURGEONINTERVENTION = STR_SURGEONINTERVENTION;
    QString DATEINTERVENTION    = STR_DATEINTERVENTION;
    QString HEUREINTERVENTION   = STR_HEUREINTERVENTION;
    QString COTEINTERVENTION    = STR_COTEINTERVENTION;
    QString SITEINTERVENTION    = STR_SITEINTERVENTION;
    QString TYPEINTERVENTION    = STR_TYPEINTERVENTION;
    QString IMPLANTINTERVENTION = STR_IMPLANTINTERVENTION;
    QString PWRIOLINTERVENTION  = STR_PWRIOLINTERVENTION;
