...
# ── Clients mysql / mysqldump embarqués ───────────────────────────────────────
# Sauvegarde et restauration en dépendent ; un poste client n'a pas forcément de MySQL. Ceux
# d'ORACLE référencent leurs bibliothèques en @loader_path/../lib : deux exécutables dans
# Contents/Applications, deux dylibs dans Contents/lib, et rien à réécrire. (Ceux de Homebrew
