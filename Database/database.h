...
public:
    ...
    */
    ...
    void exporteJointuresCotations();                           //! migre les cotations personnalisées (idUser) vers jointurescotations / jointuresccam
...
public:
    ...
    */
private:
    QJsonObject             IOLData(QVariantList refdata);                      //! attribue la liste des datas à un IOL
public:
