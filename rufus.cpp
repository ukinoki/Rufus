...
Rufus::Rufus(QWidget *parent) : QMainWindow(parent)
{
    ...
    qApp->setApplicationVersion("14-08-2026/1");
    ui = new Ui::Rufus;
    ui->setupUi(this);
            ...
            for (int i=0; i<xml.childNodes().size(); i++)
            {
                ...
                for (int j=0; j<system.childNodes().size(); j++)
                {
                    ...
                    else if (child.tagName() == "Comment")
                    {
                        ...
                        //! <ES>, <PT>, <BR>, <IT>, <RO>. On affiche celle qui correspond à la langue du poste
                        ...
                        for (int k=0; k<child.childNodes().size(); k++)
                        {
                            ...
                            if (tag=="FR" || tag=="EN" || tag=="ES" || tag=="PT" || tag=="BR" || tag=="IT" || tag=="RO")
                            {
                                hassections = true;
